...
class Core_or_General_AI_Application_Response(BaseModel):
    ...
    Core_or_General_AI_Application_reasoning: str = Field(
        description="reasoning for the classification of core AI technologies or general AI applications"
    )
class Is_Data_Centric_Response(BaseModel):
    ...
    Is_data_centric_reasoning: str = Field(
        description="reasoning for the classification of data-centric or non-data-centric"
    )
class Is_Niche_or_Broad_Market_Response(BaseModel):
...
class AI_startup_type_Response(BaseModel):
    ...
    AI_startup_type_reasoning: str = Field(
        description="reasoning for the classification of hardware, foundation model, application AI, or all others"
    )
...
class Automation_Depth_Response(BaseModel):
    ...
    automation_depth_explanation: str = Field(
        description="explanation for the classification of full automation, human-in-the-loop, or recommendation or insight only product"
    )
